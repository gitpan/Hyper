package Test::Hyper::Validator::Single::BTextField::BDateField::ValidPast;
use strict;
use warnings;
use Test::More;
...
sub startup : Test(startup => 1) {
    ...
    use_ok('Hyper::Validator::Single::BTextField::BDateField::ValidPast');
...
sub validator : Test(10) {
    ...
    my $obj;
    ok( $obj = Hyper::Validator::Single::BTextField::BDateField::ValidPast
        ->new({ owner => 'test' }), 'Object creation');

    ok( $obj->is_valid('2006-12-01'),       'string: 2006-12-01');
    ok( ! $obj->is_valid('2030-12-01'),     'string: 2030-12-01');
